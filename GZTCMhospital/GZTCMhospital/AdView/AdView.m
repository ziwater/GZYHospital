...
- (void)setAdTitleArray:(NSArray *)adTitleArray withShowStyle:(AdTitleShowStyle)adTitleStyle
{
    ...
    _centerAdLabel.frame = CGRectMake(8, kAdViewHeight - 30, kAdViewWidth - 60, 30);
...
- (void)setPageControlShowStyle:(UIPageControlShowStyle)PageControlShowStyle
{
    ...
    _pageControl.currentPageIndicatorTintColor = RGBColor(255, 255, 255);
...
//ad图片点击后链接url
- (void)setAdlinkURL:(NSArray *)adlinkURL {
    _adlinkURL = adlinkURL;
}
/**
 *  @author ZY, 15-04-26
 *
...
{
    if (_callBack) {
        _callBack(centerImageIndex,_adlinkURL[centerImageIndex]);
    }
}
