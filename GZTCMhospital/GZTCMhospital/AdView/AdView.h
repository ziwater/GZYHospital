...
@property (strong,nonatomic,readonly) UIScrollView * adScrollView;
@property (strong,nonatomic,readonly) UIPageControl * pageControl;
@property (strong,nonatomic,readonly) NSArray * imageLinkURL;
@property (strong,nonatomic,readonly) NSArray * adTitleArray;
@property (strong, nonatomic) NSArray *adlinkURL;
/**
 *  @author ZY, 15-05-17
 *
 *  设置page显示位置
 ...
 *  @brief  给图片创建点击后的回调方法
 */
@property (nonatomic,strong) void (^callBack)(NSInteger index,NSString * adlinkURL);
