...
- (void)initLabel {
    UILabel *label = [[UILabel alloc] initWithFrame:CGRectMake([UIScreen mainScreen].bounds.size.width / 2 - self.transparentArea.width / 2 , [UIScreen mainScreen].bounds.size.height / 2 + self.transparentArea.height / 2 + 30, 250, 20)];
    label.text = @"将二维码/条码放入框中，即可自动扫描";
