...
@implementation ValidateInformation
...
+ (BOOL)validatePassword:(NSString *)password {
    NSString *passwordRegular = @"[A-Za-z0-9&-@_*]{8,16}";
...
+ (BOOL)validateName:(NSString *)name {
    NSString *nameRegular = @"[\\s\\S]{1,16}";
    NSPredicate *predicate = [NSPredicate predicateWithFormat:@"SELF MATCHES %@", nameRegular];
