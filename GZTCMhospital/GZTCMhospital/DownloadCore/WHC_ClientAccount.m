...
- (NSString *)videoFolder{
    return [NSString stringWithFormat:@"%@/Documents/GZYVideo/",NSHomeDirectory()];
}

- (NSString *)docFileFolder{
    return [NSString stringWithFormat:@"%@/Documents/GZYFile/",NSHomeDirectory()];
}

- (NSString *)videoFileRecordPath{
    NSFileManager * fm = [NSFileManager defaultManager];
    NSString  * fileDirectory = [NSString stringWithFormat:@"%@/Documents/GZYPlist/",NSHomeDirectory()];
...
- (BOOL)existFileName:(NSString *)fileName{
    ...
    NSError        * error = nil;
    NSArray * fileArr = [[fileManager contentsOfDirectoryAtPath:self.docFileFolder error:&error] mutableCopy];
    if(fileArr){
