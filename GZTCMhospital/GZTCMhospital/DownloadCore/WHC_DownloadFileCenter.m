...
- (WHC_Download *)startDownloadWithURL:(NSURL *)url
    ...
    return [self startDownloadWithURL:url savePath:savePath savefileName:nil tureFileName:nil delegate:delegate];
}
...
- (WHC_Download *)startDownloadWithURL:(NSURL *)url
                          ...
                          tureFileName:(NSString *)tureFileName
                              delegate:(id<WHCDownloadDelegate>)delegate{
    WHC_Download  * download = nil;
    ...
    if([self createFileSavePath:savePath]){
        ...
        download.tureFileName = tureFileName;
